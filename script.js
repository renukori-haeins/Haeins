...
const HERO_SLIDES = [
  { img:"https://images.unsplash.com/photo-1611085583191-a3b181a88401?w=700&q=85&auto=format&fit=crop", label:"Aura Vanki Ring" },
  { img:"https://images.unsplash.com/photo-1573408301185-9146fe634ad0?w=700&q=85&auto=format&fit=crop", label:"Lune Hoop Earrings" },
...
(function(){
  ...
  track.innerHTML = HERO_SLIDES.map((s,i)=>`
    <div style="min-width:100%;height:100%;display:flex;align-items:center;justify-content:center;padding:6px;">
      <div class="img-box" style="width:100%;height:100%;max-height:260px;display:flex;align-items:center;justify-content:center;background:var(--cream-dim);">
        <div class="img-box-inner" style="display:flex;align-items:center;justify-content:center;height:220px;">
          <img src="${s.img}" alt="${s.label}" style="width:100%;height:100%;object-fit:contain;" loading="${i===0?'eager':'lazy'}" onerror="this.onerror=null;this.src='${FB}';">
        </div>
      </div>
    </div>`).join('');
